...
# Storage Data
ct = Storage.create(name: "Coffee Table", room_id: living.id, user_id: user1.id, size: "medium", photo: nil)
bs = Storage.create(name: "Bookshelf", room_id: living.id, user_id: user1.id, size: "medium", photo: nil)
cod = Storage.create(name: "Chest of Drawers", room_id: bedroom.id, user_id: user1.id, size: "large", photo: nil)
ns = Storage.create(name: "Nightstand", room_id: bedroom.id, user_id: user1.id,  size: "large", photo: nil)
# Item Data
